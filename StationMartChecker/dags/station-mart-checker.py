...
def send_sns_notification():
    ...
    message = 'CSV UPDATE ERROR\n\nIt seems like the %s file was last updated more than %d seconds ago' % (csv_file_path, file_alive_threshold)
...
def check_for_fresh_file(ds, **kwargs):
    print('Checking whether the file %s exists in hdfs server' % csv_file_path)
