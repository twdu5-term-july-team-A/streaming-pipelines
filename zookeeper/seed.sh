...
$zk_command create /tw/stationDataNYC/checkpointLocation2 hdfs://$hdfs_server/tw/rawData/stationDataNYC/checkpoints2
...
$zk_command create /tw/stationInformation/checkpointLocation2 hdfs://$hdfs_server/tw/rawData/stationInformation/checkpoints2
...
$zk_command create /tw/stationStatus/checkpointLocation2 hdfs://$hdfs_server/tw/rawData/stationStatus/checkpoints2
...
$zk_command create /tw/stationDataSF/checkpointLocation2 hdfs://$hdfs_server/tw/rawData/stationDataSF/checkpoints2
...
$zk_command create /tw/stationDataMarseille/checkpointLocation2 hdfs://$hdfs_server/tw/rawData/stationDataMarseille/checkpoints2
...
$zk_command create /tw/output/checkpointLocation2 hdfs://$hdfs_server/tw/stationMart/checkpoints2
